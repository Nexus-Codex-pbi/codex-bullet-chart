# Developer Guide – Codex Bullet Chart
...
## 2. Capabilities
- Data roles: category (Grouping), actual (Measure), target (Measure), maximum (Measure), sortOrder (Measure)
- Format pane cards: bulletSettings, qualitativeRanges, backgroundBar, labelSettings, axisSettings
