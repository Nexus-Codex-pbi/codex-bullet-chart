# Accessibility Statement – Codex Bullet Chart

## Overview
This document outlines the accessibility compliance of the **Codex Bullet Chart** Power BI custom visual.
...
## 4. Color Usage
- The visual does not rely solely on colour to convey meaning. The bullet chart uses patterns (qualitative ranges) and text labels in addition to colour.
...
## 7. Summary
**Codex Bullet Chart** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.